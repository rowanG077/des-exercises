...
def main():
    ...
    robot.add_behavior(b.StayInBoundsBehavior(robot, 90, cs_mid, move_tank))
    robot.add_behavior(b.UltrasonicDistanceBehavior(robot, 80, us, move_tank))
    robot.add_behavior(b.AvoidTouchObjectBehavior(robot, 70, ts_left, ts_right, move_tank))
    robot.add_behavior(b.SearchBehavior(robot, 10, cs_mid, move_tank))
    robot.run()
